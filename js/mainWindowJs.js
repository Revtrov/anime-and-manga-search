...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const electron = require("electron"),
        ...
        init = () => {
            ...
            let iframeSrc = readSettings().iframeSrc;
            document.getElementById("anime").src = iframeSrc;
            switch (readSettings().iframeSrc) {
                case "../anime/index.html":
                    document.getElementById("appSwitch-btn").innerHTML = "A";
                    break;
                default:
                    document.getElementById("appSwitch-btn").innerHTML = "M";
                    break;
            }
            document.getElementById("appSwitch-btn").addEventListener("click", () => {
                switch (readSettings().iframeSrc) {
                    case "../anime/index.html":
                        document.getElementById("anime").src = "../manga/index.html";
                        writeSettings("iframeSrc", "../manga/index.html");
                        document.getElementById("appSwitch-btn").innerHTML = "M";
                        break;
                    default:
                        document.getElementById("anime").src = "../anime/index.html";
                        writeSettings("iframeSrc", "../anime/index.html");
                        document.getElementById("appSwitch-btn").innerHTML = "A";
                        break;
                }
            })
            ...
            onEvent("window-title", "mouseover", "hover('window-title', 'true', 'radial-gradient(var(--border-color), transparent, transparent)')")
            onEvent("window-title", "mouseout", "hover('window-title','false')")
